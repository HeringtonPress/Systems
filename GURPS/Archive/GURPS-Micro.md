...
## Attributes
Each attribute starts at 10 (Foulkn average) for free. They can be increased using **CP**. Most adventurer's have stats between 8-20. The four attributes are as follows.

**Strength (ST)**: Sets **Hit Points (HP)**, **Basic Lift**, and **Damage (Dmg)**. Costs 10 **CP** per level.
...
**Basic Lift**: is the maximum weight you can lift over your head with one hand in one second. It is equal to (**ST**x**ST**)/5 lbs. The amount of equipment you can carry is your **Encumbrance** and is derived from **BL**. 

**Encumbrance**: is a measure of the total weight you are carrying, relative to your **ST**. The effects of encumbrance are divided into five “encumbrance levels.” All but the lowest level will reduce your actual Move to a fraction of your Basic Move and give a penalty to Dodge. These levels are numbered from 0 to 4. When a rule tells you to add or subtract your encumbrance level, this is the number to use. For instance, encumbrance gives a penalty to Climbing, Stealth, and Swimming.
...
**Heroic Charge:** When making a move and attack spend 1 FP to make the attack without the penalty to hit or skill cap.
